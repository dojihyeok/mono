...
const PROJECTS_DATA = [
    {
        ...
        matchScore: 98,
        summary: '네옴시티 옥사곤(Oxagon) 지구의 선도 기술자로 지정되었습니다. 전문가님의 전문 공정 이력과 보유 장비 숙련도가 NEOM 기준을 완벽하게 충족합니다.',
    ...
    },
    {
        ...
        matchScore: 94,
        summary: '퀸즐랜드 수소 클러스터의 핵심 정밀 통합 전문가로 매칭되었습니다. 기술 여권의 호주 진출 준비도(92%)가 결정적인 매칭 포인트입니다.',
    ...
    },
    {
        ...
        matchScore: 82,
        summary: '독일 ICE 차세대 고속철도 기술 혁신 프로젝트입니다. 전문가님의 디지털 학습 이력과 아카데미 수료 데이터가 정밀하게 매칭되었습니다.',
        pills: ['EU 블루카드', '기술 연수'],
        reward: '€ 14,800+',
        ...
        <div className={styles.container}>
            ...
            <header className={styles.header}>
                <div className={styles.titleArea}>
                    <h1>프리미엄 커리어 매칭</h1>
                    <p>검증된 경력 데이터로 전문가님의 가치를 증명할 수 있는 글로벌 프로젝트를 연결합니다.</p>
                </div>
            </header>
            ...
            <section className={styles.statusBar}>
                <div className={styles.statusInfo}>
                    <span className={styles.statusLabel}>글로벌 진출 준비도</span>
