    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        <header className={styles.header}>
          <div className={styles.passportLabel}>TECHNICAL MISSION PASSPORT</div>
          <h1 className={styles.title}>디지털 커리어 패스포트</h1>
          <p className={styles.subtitle}>VERIFIED MASTER IDENTITY & CREDENTIALS</p>
        </header>
        ...
        <section className={styles.statsSection}>
          <GlassCard className={styles.levelCard}>
            <div className={styles.levelHeader}>
              <span className={styles.badge}>MASTER COMMANDER</span>
              <span className={styles.levelPoints}>7,420 XP</span>
            </div>
            <div className={styles.progressBarWrapper}>
              <div className={styles.progressBar} style={{ width: '74%' }}></div>
            </div>
            <p className={styles.levelDesc}>LV.45 | NEXT LEVEL: GRAND MASTER (2,580 XP REMAINING)</p>
          </GlassCard>
        ...
        <section className={styles.passportCard}>
          ...
          <div className={styles.qrSection}>
            ...
            <div className={styles.qrInfo}>
              ...
              <p>현장 관리자 스캔 시 마스터의 실시간 경력 및 자격 증명이 즉시 활성화됩니다.</p>
              <div className={styles.idExpiry}>EXP: 2027. 12. 31</div>
            </div>
          </div>

          {/* Trust Radar Mockup */}
          <div className={styles.radarSection}>
            <h3 className={styles.sectionTitle}>MASTER TRUST RADAR</h3>
            <div className={styles.radarWrapper}>
              <svg width="200" height="200" viewBox="0 0 200 200">
                ...
                {/* Labels */}
                <text x="100" y="15" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">SAFETY</text>
                <text x="185" y="105" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">SKILL</text>
                <text x="100" y="195" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">PUNC</text>
                <text x="15" y="105" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">TOOLS</text>
              </svg>
            </div>
          </div>
        ...
        <section className={styles.historySection}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>DIGITAL CAREER LOG</h2>
          ...
          <div className={styles.historyList}>
            <GlassCard className={styles.historyItem}>
              <div className={styles.historyMeta}>
                ...
                <span className={styles.historyStatus}>STAMP VERIFIED</span>
              </div>
