...
# Port 3007: 구 버전 메인 사이트(old.mono.dojiung.com) 기동
echo "구 버전 메인 사이트 서버 기동 (Port 3007)..."
DATABASE_URL="file:./prisma/dev.db" PORT=3007 pm2 start node_modules/next/dist/bin/next --name "mono-old-main" --cwd /root/mono-old -- start -p 3007
