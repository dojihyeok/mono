...
# We need to replace the grid structure inside R1
...
if r1_target:
    ...
    new_r1_inner = """        <div class="flex flex-col md:flex-row gap-6 lg:gap-10">
          ...
          <!-- Column 2: Info & Strategy Summary -->
          <div class="md:w-2/3 md:pl-6 lg:border-l border-ink-900/10">
            ...
            <!-- Strategy Summary Box (Placed below 2nd column content) -->
            <div class="border-l-2 border-ink-900/15 pl-5 py-1">
              <div class="flex items-center justify-between mb-4">
                <span class="text-[15px] font-black text-ink-900">1라운드 준비 전략</span>
              ...
              <div class="bg-transparent">
                <ul class="text-[14px] text-ink-800 space-y-2.5 list-none p-0 m-0">
                  <li class="flex items-start gap-2">
                    <span class="text-tech-500 mt-1.5 text-[8px]">●</span>
                  ...
                  <li class="flex items-start gap-2">
                    <span class="text-tech-500 mt-1.5 text-[8px]">●</span>
                    <span class="leading-tight"><strong class="text-ink-900 font-bold">규제·투자·네트워크:</strong> 사전 규제 대응 / VC·SI 연계 / 공공·민간 파트너십 구축</span>
                  </li>
                  <li class="flex items-start gap-2">
                    <span class="text-tech-500 mt-1.5 text-[8px]">●</span>
                    <span class="leading-tight"><strong class="text-ink-900 font-bold">MVP 및 지원금:</strong> 1R 200만원(MVP 검증) / 2R 진출 시 1,000만원(실제 서비스 검증)</span>
                  </li>
                </ul>
              </div>
            </div>
...
"""
    ...
    with open('public/pitch.html', 'w', encoding='utf-8') as f:
        f.write(html)
    print("Replaced R1 layout again.")
else:
