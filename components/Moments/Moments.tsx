...
const moments = [
  ...
  },
  {
    ...
    keyMessage: '군대 가기 전, 혹은 인생의 다음 단계를 준비하기 위해\n일하며 돈을 모으는 시간도 MONO 안에서 경력이 됩니다.',
  ...
  },
  {
    ...
    keyMessage: '기술은 한 곳에 묶이는 것이 아니라,\n내가 원하는 삶의 형태를 능동적으로 선택하는 자유가 됩니다.',
    ...
    features: [
      ...
      '지역 기반 정밀 매칭 광고',
      '팀 단위 대형 일자리 알선 수수료',
      'MONO Field Operations 오프라인 인프라',
    ],
    emoji: '🌊',
    color: '#3B82F6',
  },
  {
    ...
    keyMessage: '퇴사, 은퇴, 업종 전환 이후에도\n내 기술 이력은 삶의 가치를 지켜주는 든든한 무형의 무기가 됩니다.',
    scene: '갑작스러운 이별 통보 같은 퇴사. 그래도 내 손에는 나만의 기술이 남았습니다.',
    description:
  ...
  },
  {
    ...
    features: [
      ...
      'AGI Core OS',
      'Tech-Blue 스마트 임대/구독',
      '스마트 정밀 장비·소모자재 거래 데이터',
      'AGI Core OS 의사결정 B2B SaaS',
    ],
    emoji: '🚀',
    color: '#EC4899',
  },
