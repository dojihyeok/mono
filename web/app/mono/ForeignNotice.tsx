...
const NOTES: Record<ForeignNoticeKind, string> = {
  ...
  settlement:
    "표시되는 정산 내역은 확인을 돕기 위한 참고용입니다. 실제 임금 지급·세무·노무 처리는 당사자와 세무·노무 전문 파트너의 책임 하에 진행됩니다.",
  glossary:
    "번역은 현장 의사소통을 돕기 위한 보조 기능입니다. 안전·계약 등 법적 효력이 필요한 사항은 반드시 공식 문서와 정식 통역을 따르세요.",
  partner:
