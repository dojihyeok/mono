...
<script>
  ...
  // Run immediately
  resizeFlowchart();
  setTimeout(resizeFlowchart, 100);
</script>
</div>
"""
...
if image_tag in html:
    ...
    with open('web/public/strategy.html', 'w', encoding='utf-8') as f:
        f.write(html)
    print("Replaced pristine HTML with V3 script successfully.")
else:
    print("Error: Image tag not found. Script failed.")
